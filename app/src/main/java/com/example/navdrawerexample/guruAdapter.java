...
public class guruAdapter extends RecyclerView.Adapter<guruAdapter.MyViewHolder> {
    ...
    public guruAdapter(Context context, ArrayList<Model> model, RecyclerViewClickListener listener) {
    ...
    public guruAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.activity_guru, parent, false);
        return new guruAdapter.MyViewHolder(view);
    }
    ...
    @Override
    public void onBindViewHolder(@NonNull guruAdapter.MyViewHolder holder, final int position) {
